...
<div class="container">
    <h1>Add New Place</h1>
    <hr>
    <form class="form-horizontal" method="post" action="show-place">
        <div class="form-group">
            <input type="submit" class="btn btn-dark col-md-2" value="Show Places">
        </div>
    </form>
    <form class="form-horizontal" method="post" action="save-place">
    <div class="form-group">
